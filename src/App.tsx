  ...
  return <>
    ...
    <main id="main">
      {screen === 'home' ? <>
        ...
        {screen === 'learn' && <><div className="play-top"><span className="eyebrow">{deck[language]} · {t('LEARN')}</span><span>{language === 'et' ? `Kaart ${cardIndex + 1} / 6` : `Card ${cardIndex + 1} of 6`}</span></div><article className="learning-flip" key={card.id}>
