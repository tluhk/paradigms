...
- **Paradigms:** positivism, postpositivism, critical realism, interpretivism, constructivism, pragmatism, and critical/transformative approaches, with links to ontology, epistemology, and axiology.
- **Methodology:** case study, experimental design, ethnography, phenomenology, grounded theory, mixed methods research, action research, and design science research.
- **Methods:** observation, interview, requirements interview, focus group, questionnaire, usability testing, descriptive statistics, and thematic analysis.

Within decks, related paradigms are adjacent, methodologies progress from study designs through interpretive and integrated inquiry to practical change and artifact design, and data-collection methods precede analysis methods. This is a suggested teaching order, not a ranking or a mandatory research workflow.
...
After checking a tree, open **Explore quality decisions** for six short lessons on sampling, bias/reflexivity, consent/privacy, validity/reliability, qualitative trustworthiness, and limitations. Each scenario offers four decisions: participant selection, one scenario-specific quality issue, recording/consent, and reporting scope. Feedback explains each choice. Quality practice has separate first-answer and current results; retrying does not overwrite first answers or change tree scores/completion. Answers and the open panel are saved per scenario, including across References visits. Restart scenario clears them.

In the **Campus room finder**, **Accessible course planner**, and **Equipment lending system** scenarios, check the tree and open **Explore fictional evidence**. Each exercise presents eight task records from four invented participants, calculated success rates/median successful times/error totals, and two invented participant excerpts. Three questions connect observed patterns, limits of the comparison, and a prototype revision to test next. Failures stay visible and are excluded from successful-time medians rather than treated as zero; task definitions, timing rules, participant context, and fixed-order limitations are stated.

Evidence exercises work in both languages and save answers and panel visibility per scenario. Retries preserve first answers; evidence results remain separate from placement and quality scores. References visits and refresh retain drafts; Restart scenario clears them. The datasets are fictional teaching examples, not empirical findings or evidence that the suggested revisions work. These introductory exercises do not perform inferential statistical tests.

The quality lessons distinguish quantitative measurement criteria from context-sensitive qualitative criteria. Their references include [sampling guidance for software engineering](https://arxiv.org/abs/2002.07764v6), [Open University discussion of research quality](https://www.open.edu/openlearn/education-development/learning-teach-introduction-classroom-research/content-section-5), and [OHRP informed-consent guidance](https://www.hhs.gov/ohrp/regulations-and-policy/guidance/faq/informed-consent/index.html). OHRP guidance has a U.S. regulatory context; learners must follow local institutional requirements. Completing the practice is not ethics approval or validation of a real study.
...
The bibliography covers all 29 learning concepts (including seven named paradigms) and four evaluation choices, plus sources for six research-quality lessons. It includes author names, publication dates where specified, titles, publication details, and DOI identifiers where available. English and Estonian share the same source mappings; original source titles are retained. Thematic analysis includes both the 2006 article and the authors’ subsequent teaching resources. Some publisher links may restrict full-text access.
...
- `src/content/evidence.ts`: fictional task records, excerpts, calculated summaries, and interpretation questions. Increment an exercise’s version when changing its evidence or answer meanings so outdated drafts restart safely.
- `src/content/quality.ts`: bilingual quality lessons and scenario decisions; first-answer and retry results are managed separately from placement scores.
